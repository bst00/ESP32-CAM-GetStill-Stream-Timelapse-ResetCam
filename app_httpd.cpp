...
static esp_err_t resetCamHandler(httpd_req_t *req)
{
  Serial.println("Resetting Camera in 3s...");
  delay(3000);
	ESP.restart();
}
...
{
  Serial.print("Stopping Time Lapse...app_httpd.cpp");
	stopLapse();
}
